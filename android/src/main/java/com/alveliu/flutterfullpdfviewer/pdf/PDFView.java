 ...
 */
package com.alveliu.flutterfullpdfviewer.pdf;
...
import com.alveliu.flutterfullpdfviewer.R;
import com.alveliu.flutterfullpdfviewer.pdf.exception.PageRenderingException;
import com.alveliu.flutterfullpdfviewer.pdf.listener.OnDrawListener;
import com.alveliu.flutterfullpdfviewer.pdf.listener.OnErrorListener;
import com.alveliu.flutterfullpdfviewer.pdf.listener.OnLoadCompleteListener;
import com.alveliu.flutterfullpdfviewer.pdf.listener.OnPageChangeListener;
import com.alveliu.flutterfullpdfviewer.pdf.listener.OnPageErrorListener;
import com.alveliu.flutterfullpdfviewer.pdf.listener.OnPageScrollListener;
import com.alveliu.flutterfullpdfviewer.pdf.listener.OnRenderListener;
import com.alveliu.flutterfullpdfviewer.pdf.listener.OnTapListener;
import com.alveliu.flutterfullpdfviewer.pdf.model.PagePart;
import com.alveliu.flutterfullpdfviewer.pdf.scroll.ScrollHandle;
import com.alveliu.flutterfullpdfviewer.pdf.source.AssetSource;
import com.alveliu.flutterfullpdfviewer.pdf.source.ByteArraySource;
import com.alveliu.flutterfullpdfviewer.pdf.source.DocumentSource;
import com.alveliu.flutterfullpdfviewer.pdf.source.FileSource;
import com.alveliu.flutterfullpdfviewer.pdf.source.InputStreamSource;
import com.alveliu.flutterfullpdfviewer.pdf.source.UriSource;
import com.alveliu.flutterfullpdfviewer.pdf.util.ArrayUtils;
import com.alveliu.flutterfullpdfviewer.pdf.util.Constants;
import com.alveliu.flutterfullpdfviewer.pdf.util.MathUtils;
import com.alveliu.flutterfullpdfviewer.pdf.util.Util;
...
public class PDFView extends RelativeLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (bg == null) {
            canvas.drawColor(nightMode ? getResources().getColor(R.color.background_dark) : Color.WHITE);
        } else {
            bg.draw(canvas);
        }
